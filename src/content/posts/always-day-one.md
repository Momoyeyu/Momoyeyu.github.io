...
2025 年上半年，朋友们陆续在大厂开始实习的时候，我还在学校实验室里埋头干活。实验室的活不少但也封闭，他们在接触真正的工业级问题，我在原地踏步。这种落差感一直在心里翻搅。后来我想明白了：如果不自己迈出去，就会错过一段关键的成长期。于是下了决心——要去就去头部大厂，否则就不去。

准备的时间比预想的长。改简历、刷 LeetCode、还要兼顾实验室的活和课程，一直拖到五月初才真正开始投递。接下来是将近两个月的密集面试——在腾讯和字节的多个团队一共面了大约十一轮。过程并不顺利，被字节的好几个团队连着拒，确实有点疲。

但讽刺的是，这种疲劳反而帮了我。等到我最初投递的 TikTok 团队终于联系我时，我已经不怎么想那么多了。紧张感消失了，该说的点早就烂熟于心，面试变成了真正的技术交流。有一轮，大部分时间都在聊 AI，正好是我最熟的方向。面试官开玩笑说我代码写得一般般，但还是给过了——甚至跳过了三面，直接送到 HR。
...
我们的工位在北京紫金数码园——一栋偏老的租赁办公楼。但对第一次进大厂的人来说，一切都很新鲜：免费的饭、健身房、零食柜、升降桌、大显示器。更重要的是团队氛围。字节的组织结构非常扁平，作为实习生，我和正式员工有同样的发言权——只要你的论点站得住脚，没人会因为你的 title 而打折扣。同事们下班后会找我聊天、约我打乒乓球、一起散步。工作和生活的边界很清晰，也被尊重。这种舒适感让我很快就进入了状态。

## 进入核心

热身结束后，我接到了真正有业务影响的工作：为常规流量迁移场景实现自动扩缩容。这里的流量迁移指的是为了降本或基础设施切换而在数据中心之间调度流量，不是紧急容灾。这个能力之前从没集成进平台。以前在迁移过程中的容量伸缩完全依靠 SRE 手动协调资源——慢、容易出错、信息还经常滞后。我们的目标是让系统自动根据流量变化推算容量需求，一键完成跨数据中心的扩缩容。

但说实话，我当时的理解远没有上面这段总结写得这么清楚。我以为这活很直接：调底层组件的扩缩容 API，传参数，触发，完事。这个思路抓住了核心，但完全没考虑到流量迁移场景下的复杂性。整个 Q3，我在 Redis 自动扩缩容上经历了好几轮推翻重做，勉强在十一假期前把功能跑通，连好好测一遍的时间都没留下就放假了。

但那段时间也有意外的美好。十一前后，我申请了去深圳办公室办公，拿到了 leader 的批准。深圳的工区在景湖大厦，紧挨着深圳湾公园。在家乡工作有一种不太真实的感觉——家离公司近得不像话，每天通勤变成了一件期待的事。
...
现 mentor 是一位经验丰富的工程师，对代码质量有极高的标准。接手流量迁移项目后，他带来了一大波新想法。原本只是一次常规的重构讨论，在他近乎完美主义的要求下，逐步升级成了平台的整体重写。我和同事 A、同事 B——三个一线开发花了一个多月反复打磨设计方案，最终得出了这个结论。
...
经过数周的高强度工作——有段时间连续一个多星期打车到凌晨才到家——我完成了所有被分配的任务：TCE 和 Redis 两个核心组件在流量迁移场景下的自动扩缩容支持。

## 最后的日子

我在入职之前就定好了离职日期：12 月 25 号，圣诞节。到了十二月，手头的活在收尾，但有一种奇怪的"人已经半走了"的感觉。我开始一个人吃午饭，减少闲聊，午休时间去办公室附近的公园走走。
...
每个人都尊重我的决定。没有隆重的告别，没有仪式。一切自然地收了尾。直到我把工牌交到前台的那一刻，这六个月才真正变得真实——然后就结束了。

## Always Day One

走出紫金数码园之前，我停下来拍了一张字节跳动 logo 墙的照片。也许我再也不会踏进这间办公室了，但我想留下点什么来记住它。
...
"Always Day One" 不是一句空话。它是一种选择——把每一次挫折当作新的起点，以一个永远的学习者的姿态保持谦逊，相信推倒重来不是什么可怕的事。我带着六个月的成长和一个信念离开了字节：无论下一站去哪，我都准备好了从 Day One 重新开始。
